...
void s21::ViewQt::drawGame(QPainter* painter){
    ...
    for (int i = 0; i < 4; i++) {
        ...
        painter->drawRect((data->next.pixels[i].x * PIXEL ) + 250,(data->next.pixels[i].y+1) * PIXEL ,29, 29);
...
//    painter->s
    ...
    painter->drawText(3 * PIXEL , 10 * PIXEL , "TETRIS"); // Отрисуйте текст с помощью цвета шрифта
