...
namespace s21 {
  ...
  /// @brief A model of the MVC paternoster in which snake and "apple" initialization is implemented. This class implements checks for collisions, coordinate changes when changing the direction of movement
  class Model {
