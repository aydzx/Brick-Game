...
/// @brief Normalizing shape coordinates when rotated at the edge of the playing field
/// @param curr 
...
/// @brief Removes a line from the field and moves all lines above it down by one
/// @param GameField 
/// @param y 
